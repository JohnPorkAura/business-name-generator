"""
Business pork — Find the perfect name for your business
...
DB_FILE      = "business_pork.db"
SYSTEM_PROMPT = "You are an expert Business pork assistant. Describe your business, industry, and vibe. Get creative name options with domain suggestions and branding rationale."

app = FastAPI(title="Business pork")
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Business pork</div>
    <div class="auth-sub">Find the perfect name for your business</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Business pork</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Business pork</em><br>Find the perfect name for your business</h1>
    <p>Describe your business, industry, and vibe. Get creative name options with domain suggestions and branding rationale. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <textarea id="field-industry" placeholder="Enter industry..." required></textarea>
    </div>
    <div class="field">
      <label for="field-keywords">Keywords</label>
      <input type="text" id="field-keywords" placeholder="e.g. your keywords">
    </div>
    <div class="field">
    ...
    <div class="field">
      <label for="field-count">Count</label>
  ...
  <footer>
    <div class="foot-note">Business pork &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Business pork assistant. Describe your business, industry, and vibe. Get creative name options with domain suggestions and branding rationale.",
  promptTemplate: "Industry: {{industry}}\\nKeywords: {{keywords}}\\nStyle: {{style}}\\nCount: {{count}}",
  resultFormat:   'list', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "industry", "label": "Industry", "type": "textarea", "placeholder": "Enter industry...", "required": true}, {"id": "keywords", "label": "Keywords", "type": "text", "placeholder": "e.g. your keywords", "required": false}, {"id": "style", "label": "Style", "type": "select", "options": ["Creative", "Descriptive", "Metaphorical", "Short & punchy", "Professional"], "required": false}, {"id": "count", "label": "Count", "type": "select", "options": ["5", "10", "15", "20"], "required": false}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Business pork", "ai_ready": bool(GROQ_API_KEY)}
